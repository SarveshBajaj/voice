...
def mysptotal(m,p):
    ...
    try:
        ...
        # print(z2)
        b = mysppron(m,p,objects)
        checklist = myspgend(m,p,objects)
        # print(checklist)
        dataset={"number_ of_syllables":z2[0],"number_of_pauses":z2[1],"rate_of_speech":z2[2],"articulation_rate":z2[3],"speaking_duration":z2[4],
                          "original_duration":z2[5],"balance":z2[6],"f0_mean":z2[7],"f0_std":z2[8],"f0_median":z2[9],"f0_min":z2[10],"f0_max":z2[11],
                          "f0_quantile25":z2[12],"f0_quan75":z2[13], "Pronunciation_posteriori_probability_score_percentage":float("{0:.2f}".format(b)),
                          "Gender and Mood of Speech":checklist[0],
                          "p-value/sample size":[checklist[1],checklist[2]]}
...
def myspgend(m,p,objects):
    ...
    try:
        ...
        if mm[3]<=0.09:
            ...
            mmm=0.35
        if z4>97 and z4<=114:
            word = "a Male, mood of speech: Showing no emotion, normal"
        elif z4>114 and z4<=135:
            word = "a Male, mood of speech: Reading"
        elif z4>135 and z4<=163:
            word = "a Male, mood of speech: speaking passionately"
        elif z4>163 and z4<=197:
            word = "a female, mood of speech: Showing no emotion, normal"
        elif z4>197 and z4<=226:
            word = "a female, mood of speech: Reading"
        elif z4>226 and z4<=245:
            word = "a female, mood of speech: speaking passionately"
        else:
            word = "Voice not recognized"

        return[word,float("{0:.2f}".format(mmm)),nnn]
